...
// ─── Category data ────────────────────────────────────────────────────────────
const CATEGORIES = [
  { name: 'Y-Combinator',       icon: 'Y',     bg: '#FF6600', accent: '#f97316', textColor: 'white'   },
  { name: 'Techstars',          icon: 'TS',    bg: '#1a1a1a', accent: '#ffffff', textColor: 'white'   },
  { name: 'Antler',             icon: 'AN',    bg: '#CC2936', accent: '#ef4444', textColor: 'white'   },
  { name: '500 Global',         icon: '500',   bg: '#0d2137', accent: '#3b82f6', textColor: 'white'   },
  { name: 'Pear VC',            icon: 'PEAR',  bg: '#C8D749', accent: '#22c55e', textColor: '#1a1a1a' },
  { name: 'AngelPad',           icon: 'AP',    bg: '#222222', accent: '#ef4444', textColor: 'white'   },
  { name: 'First Round',        icon: 'FR',    bg: '#f5f5f5', accent: '#1a1a1a', textColor: '#1a1a1a' },
  { name: 'A16z',               icon: 'A16Z',  bg: '#f26522', accent: '#f97316', textColor: 'white'   },
  { name: 'Sequoia Capital',    icon: 'SEQ',   bg: '#2d7a4f', accent: '#22c55e', textColor: 'white'   },
  { name: 'NfX',                icon: 'NFX',   bg: '#1a3d8f', accent: '#3b82f6', textColor: 'white'   },
  { name: 'Initialized Capital',icon: 'IC',    bg: '#111111', accent: '#ffffff', textColor: 'white'   },
  { name: 'Floodgate',          icon: 'FG',    bg: '#1e3a8a', accent: '#60a5fa', textColor: 'white'   },
  { name: 'Benchmark',          icon: 'BM',    bg: '#1e3a8a', accent: '#60a5fa', textColor: 'white'   },
  { name: 'Founders Fund',      icon: 'FF',    bg: '#f5f5f5', accent: '#1a1a1a', textColor: '#1a1a1a' },
  { name: 'Lightspeed',         icon: 'LS',    bg: '#f26522', accent: '#f97316', textColor: 'white'   },
  { name: 'Accel',              icon: 'ACCEL', bg: '#CC2936', accent: '#ef4444', textColor: 'white'   },
  { name: 'Index Ventures',     icon: 'IV',    bg: '#CC2936', accent: '#ef4444', textColor: 'white'   },
  { name: 'Bessemer',           icon: 'BV',    bg: '#1e3a8a', accent: '#60a5fa', textColor: 'white'   },
]
              ...
              {CATEGORIES.map((cat, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span
                        className="font-black text-sm leading-none select-none px-1 text-center"
